...
class UnilmForPreTraining(BertForPreTraining):
    ...
    def forward(self, input_ids, attention_mask, token_type_ids, task, *arg, **kwargs):
...
model = DDP(model, device_ids=[0], output_device=local_rank, find_unused_parameters=True)
